...
pub struct ClaimDelayedOrder<'info> {
    #[account(mut)]
...
pub fn handle(ctx: Context<ClaimDelayedOrder>, campaign_id: u64) -> Result<()> {
    ...
    require!(
        now >= campaign_state.release_date + global_state.claim_after_in_seconds,
